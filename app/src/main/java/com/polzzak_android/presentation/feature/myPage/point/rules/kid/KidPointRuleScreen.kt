package com.polzzak_android.presentation.feature.myPage.point.rules.kid
...
fun KidPointRuleScreen() = Column(
    ...
    RuleBox(
        title = "포인트 적립",
        strings = stringArrayResource(id = R.array.point_rules_kid_positive),
...
@Preview
@Composable
private fun KidPointRuleScreenPreview() {
    KidPointRuleScreen()
}