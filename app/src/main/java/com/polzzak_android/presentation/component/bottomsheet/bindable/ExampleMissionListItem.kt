...
class ExampleMissionListItem(
    val model: MissionModel,
    private val interaction: BottomSheetExampleMissionListClickInteraction
) :
    ...
    override fun bind(binding: ItemMissionBinding, position: Int) {
        with(binding) {
            ...
            root.setOnClickListener {
                ...
                interaction.onExampleMissionClick(model)
            }
        }
    }
...
interface BottomSheetExampleMissionListClickInteraction {
    fun onExampleMissionClick(model: MissionModel)
}